goals = {
    "travel": { "title": "Для путешествий", "pic": "⛱" },
    "study": { "title": "Для учебы", "pic": "🏫" },
    "work": { "title": "Для работы", "pic": "🏢" },
    "relocate": { "title": "Для переезда", "pic": "🚜" },
    "coding": {"title":"Для программирования", "pic":"💻"}
}
